...
INSERT INTO `bids` VALUES (22,13,16,50.00,'valid'),(23,13,18,25.00,'valid'),(24,13,17,45.00,'valid'),(25,14,16,45.00,'valid'),(26,14,17,30.00,'valid'),(27,14,18,30.00,'valid'),(28,14,19,50.00,'valid'),(29,14,20,40.00,'valid');
...
INSERT INTO `cart` VALUES (1,12,16,25,2,'complete'),(2,12,16,22,1,'complete'),(3,12,18,23,2,'complete');
...
INSERT INTO `posts` VALUES (16,12,6,'Data Structures',2008,'Pearson Publications','new','active','Chris Davis'),(17,12,6,'Algorithms Design',2005,'PHI Publishers','new','active','Cormen'),(18,12,3,'Harry Potter Part 6',2011,'ABC Publishers','new/used','active','J K Rowling'),(19,13,1,'Network Security',2010,'Pearson Publications','used','active','Kamil Sarac'),(20,13,6,'Data and Application Security',2006,'Oxford Publishers','used','active','Murat'),(21,14,7,'Easy ways to learn oil painting',2011,'PHI Publishers','new','active','Andrew Paul'),(22,14,5,'Learn to cook in 100 days',2009,'ABC Publishers','new/used','active','Elizabeth Stephen');
...
INSERT INTO `user_account` VALUES (12,'Niveditha','Varadha Chandrasekaran','niveditha0706@gmail.com','nive1234','4697329628','2016-12-05 17:25:26','Dallas, TX, USA'),(13,'Bhanu','Arora','bhanuarora2628@gmail.com','bhanu1234','4697896532','2016-12-05 16:41:43','Richardson, TX, USA'),(14,'Ramya','Bettachari','ramya58b@gmail.com','ramya123','4698563215','2016-12-05 17:16:54','Richardson, TX, USA'),(15,'Aesha','Delhiwala','niveditha1990@gmail.com','aesha1234','4698996532','2016-12-05 17:12:20','Richardson, TX, USA');
...
BEGIN
	...
	update cart set status="complete" where user_id = p_user_id and status = "open";
	IF ROW_COUNT() > 0 THEN
		set p_result = 0;
	else
		set p_result = -1;
...
-- Dump completed on 2016-12-05 11:59:39
