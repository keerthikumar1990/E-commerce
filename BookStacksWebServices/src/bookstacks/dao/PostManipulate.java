...
public class PostManipulate {
	...
	public Response createPost (MultivaluedMap<String, String> post ) throws Exception {
		System.out.println("BookStacksWebServices - createPost started");
		int response = -1;
			...
			System.out.println("BookStacksWebServices - createPost finished");
	...
	public String getPostDetails(MultivaluedMap<String, String> user) throws Exception {
		System.out.println("BookStacksWebServices - getPostDetails started");
        ...
        System.out.println("BookStacksWebServices - getPostDetails finished");
		return mapAsJson;
	...
	public String getMyPosts(MultivaluedMap<String, String> user) throws Exception {
		System.out.println("BookStacksWebServices - getMyPosts started");
        ...
        System.out.println("BookStacksWebServices - getMyPosts finished");
