...
public class AccountManipulate {
	...
	public Response registerUser (MultivaluedMap<String, String> user) throws Exception{
		System.out.println("BookStacksWebServices - registerUser started");
		int response = -1;
		...
		System.out.println("BookStacksWebServices - registerUser finished");
	...
	public String validateUser(MultivaluedMap<String, String> user) throws Exception {
		System.out.println("BookStacksWebServices - validateUser started");
	    int flag =-1;
		...
		calstat.close();
		System.out.println("BookStacksWebServices - validateUser finished");
